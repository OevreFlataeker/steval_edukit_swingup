...
Unfortunately this also requires "patching" the file x_nucleo_ihm01a1_stm32f4xx.h of the BSP in order to switch TIM3 and TIM2 on all relevant code portions, because we must let the BSP code generate
the PWM then via TIM2 as well.
